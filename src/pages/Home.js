...
const Home = () => {
  const { accounts, addAccounts, addselectedAccount, selectedAccount } =
    useAccountContext();
  ...
  const algosignerConnect = async (e) => {
    if (typeof AlgoSigner !== "undefined") {
      const connectAccounts = await AlgoSigner.connect().then(() =>
        AlgoSigner.accounts({
          ledger: "MainNet",
        })
      );
  ...
  const handleImport = async () => {
    setIsLoading(true);
    const account = recoverAccount(mnemonic);
    if (account) {
      const accountInfo = await getInfo(account);
      accountInfo["mnemonic"] = account["mnemonic"];
      addselectedAccount(accountInfo);
    } else {
  ...
  const handleSubmit = async () => {
    ...
    accountInfo["mnemonic"] = generatedAccount["mnemonic"];
    addselectedAccount(accountInfo);
    setIsLoading(false);
  };

  return selectedAccount.address === undefined ? (
    <>
          ...
          >
            <List>
              <Box sx={{ p: 5, textAlign: "center" }}>
                ...
                />
                <Typography variant="h3">Algorand</Typography>
              ...
              <DarkCard>
                <CardActionArea onClick={() => algosignerConnect()}>
                  ...
                  >
                    ...
                    <Typography component="p">
                      Simply Create or import your Algorand account and approve
                      or deny transactions all from within your browser
                    </Typography>
                  </CardContent>
                </CardActionArea>
              </DarkCard>
              ...
              <CardContent>
                ...
                <Box sx={{ p: 2, mb: 2, background: "rgba(0,0,0,0.2)" }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <b>Mnemonic</b>
                    <Box
                      sx={{ p: 1, backgroundColor: "rgba(255,255,255,0.8)" }}
                    >
                      <Typography
                        component="p"
                        sx={{ fontSize: "0.9em", wordBreak: "break-word" }}
                      >
                  ...
                  <Typography component="p">
                    Make sure you have the entire <b>25-word mnemonic</b>, or
                    you will <b>lose access to this account forever</b>.
                  </Typography>
                  <Typography component="p">
          ...
          <Box>
            ...
            >
              <Box component="span" className="logo">
                <Avatar
                  src="data:image/jpeg+xml;base64,"
                  alt="logo"
              ...
              <Box className="body">
                {accounts.map((algoAccount, index) => (
                  <Box
                    key={index}
                    className="account"
                    onClick={() => handleWalletSelected(index)}
                  >
                    {algoAccount.address}
                  </Box>
                ))}
